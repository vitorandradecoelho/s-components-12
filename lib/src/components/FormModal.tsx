...
const FormModal: React.FC<FormModalProps> = ({ isOpen, onClose }) => {
  ...
  const footer = (
    <div className="flex gap-3">
      <button 
        className="px-6 py-2 bg-primary text-primary-foreground rounded-lg text-xs uppercase font-medium hover:bg-primary/90 transition-colors"
        onClick={() => handleSubmit('saveAndAssign')}
      >
        Guardar y Asignar
      </button>
      <button 
        className="px-6 py-2 bg-blue-500 text-white rounded-lg text-xs uppercase font-medium hover:bg-blue-600 transition-colors"
        onClick={() => handleSubmit('save')}
      >
        Guardar
      </button>
      <button 
        className="px-6 py-2 bg-gray-500 text-white rounded-lg text-xs uppercase font-medium hover:bg-gray-600 transition-colors"
        onClick={onClose}
      >
        Cancelar
      </button>
