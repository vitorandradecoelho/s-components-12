...
try {
  ...
  // 3. Copiar estilos para o projeto de documentação
  console.log('📋 Sincronizando estilos...');
  const srcStyles = path.join(__dirname, '../src/styles/index.css');
  const docStyles = path.join(__dirname, '../../src/index.css');
  const stylesContent = `/* Importa os estilos da biblioteca */\n@import '../lib/src/styles/index.css';`;
  fs.writeFileSync(docStyles, stylesContent, 'utf8');
  console.log('✅ Estilos sincronizados');
