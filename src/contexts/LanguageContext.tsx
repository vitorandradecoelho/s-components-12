...
const translations = {
  pt: {
    ...
    'component.accordion.title.description': 'Componente accordion interativo',
    'component.accordion.question1': 'O que e este Componente?',
    'component.accordion.response1': 'Este é um componente accordion personalizado construído com React, Tailwind CSS e shadcn/ui. Possui um belo esquema de cores verde personalizado (#B5D651).',
    'component.accordion.question2': 'Integração com o sistema de design',
    'component.accordion.response2': 'Todas as cores são definidas como propriedades CSS personalizadas e integradas com Tailwind CSS, tornando-as reutilizáveis em toda a sua aplicação.',
    'component.accordion.question3': 'Elemento Accordion Reutilizável',
    'component.accordion.response3': 'Este accordion pode ser facilmente exportado e integrado em outros projetos, garantindo consistência visual e reutilização de código.',   
